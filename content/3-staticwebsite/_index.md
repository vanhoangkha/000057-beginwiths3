...
1. Next we will turn on the static website feature

    - In the **S3 bucket** interface, select **Properties**
...
4. Check again and select **Save changes**

![Static website](/images/3-staticwebsite/0004.png?featherlight=false&width=90pc)

5. Complete enable **static website hosting** feature
