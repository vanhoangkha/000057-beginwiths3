...
Để có thể truy cập vào website được host chúng ta sẽ cấu hình lại **Block Public Access**

1. Trong giao diện **S3 bucket**

   - Chọn **Permissions**
   - Hiện tại, chúng ta thấy **Block all public access** đang **On**
...
3. Xác nhận **confirm** và chọn **Confirm**
