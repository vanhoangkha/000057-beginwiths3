...
![Static website](/images/9-moveobject/0000.png?featherlight=false&width=50pc)

1. Next we will create a new **bucket**

   - In the **S3 bucket** console, select **Create bucket**

   ![Static website](/images/9-moveobject/0001.png?featherlight=false&width=90pc)
   ...
   ![Static website](/images/9-moveobject/0002.png?featherlight=false&width=90pc)

   - Keep the default values, scroll to the bottom of the page, select `Create bucket`

   ![Static website](/images/9-moveobject/0003.png?featherlight=false&width=90pc)

2. Move files between **Buckets**

   - In the **Amazon S3** console, select bucket **aws-first-cloud-journey**

   ![Static website](/images/9-moveobject/0004.png?featherlight=false&width=90pc)
   ...
   ![Static website](/images/9-moveobject/0005''.png?featherlight=false&width=90pc)
   ...
   ![Static website](/images/9-moveobject/0006.png?featherlight=false&width=90pc)

   - Select **S3 Buckets**

   ![Static website](/images/9-moveobject/0007.png?featherlight=false&width=90pc)

   - Select bucket name **aws-first-cloud-journey-move**, select **Choose destination**

   ![Static website](/images/9-moveobject/0008.png?featherlight=false&width=90pc)
   ...
   ![Static website](/images/9-moveobject/0009.png?featherlight=false&width=90pc)

   - Congratulations, you have successfully moved the file, select **Close**

   ![Static website](/images/9-moveobject/00010.png?featherlight=false&width=90pc)

3. Check the Object in the new Bucket

   - In the **Amazon S3** console, select bucket name **aws-first-cloud-journey-move**

   ![Static website](/images/9-moveobject/00011.png?featherlight=false&width=90pc)

   - Check the **square** symbol next to the **Name** value to select all Objects in the bucket

   - Select **Action**, select **Calculate total size**

   ![Static website](/images/9-moveobject/00012.png?featherlight=false&width=90pc)
   ...
   ![Static website](/images/9-moveobject/00013.png?featherlight=false&width=90pc)
